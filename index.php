    ...
    <div class="container text-center">
        <div class="row">
            ...
            <h1>БАЗА ДАНИХ "АВТОСАЛОН"</h1>
                <img class="rounded-img" src="a9.jpg" alt="Картинка не відображена" />
                <h1>Головна сторінка</h1>
                <h2>Вітаємо, <?= isset($_SESSION['logged_user']) ? $_SESSION['logged_user']->login : "Гість"; ?>!</h2>
                <div class="container">
                    <p class="lead text-muted col-lg-10 mx-auto">База даних розроблена студентом:</p>
                    <p class="lead text-muted col-lg-10 mx-auto">Пармьонов Є.М.</p>
                </div>

                <?php if (isset($_SESSION['logged_user'])) : ?>
                    <hr>
                    <a href="all.php" class="btn btn-primary">Головне меню</a><br>
