...
<head>
    ...
    margin: 10px;
    cursor: pointer;
    background-color: #0000f4; /* Новий колір кнопок */
    color: #fff;
    border: none;
    border-radius: 5px;
...
button:hover {
    background-color: #000d9b; /* Новий колір кнопок при наведенні */
}
        select {
    width: 100%;
    padding: 10px;
...
<body>
    ...
    ?>
            ...
            <input type="text" name="address_buy" id="address_buy" value="Cars Building, Berlin 121-0042, Germany
" required>
