...
if (isset($_SESSION['logged_user'])) {
    ...
    echo '<button type="button" class="btn btn-primary" onclick="location.href=\'index.php\'">Головна сторінка</button>';
} else {
    // Якщо ні, вивести кнопку для входу
    echo '<button type="submit" name="do_login" class="btn btn-primary">Вхід</button>';
}
?>
</form>
